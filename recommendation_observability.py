...
def build_recommendation_trace(
    *,
    ...
    gangnam_representative_support_boost_applied_count: int = 0,
    gangnam_representative_support_boost: float = 0.0,
    ...
    return {
        ...
        **gangnam_support_trace,
        ...
        "gangnam_representative_support_boost_applied": bool(gangnam_representative_support_boost_applied_count),
        "gangnam_representative_support_boost_count": int(gangnam_representative_support_boost_applied_count or 0),
        "gangnam_representative_support_boost": round(float(gangnam_representative_support_boost or 0.0), 4),
